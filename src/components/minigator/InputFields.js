    ...
    <div className="relative w-full">
      ...
      <div className="absolute top-2 right-2">
        <button
          ...
          className="h-10 w-20 text-white rounded-lg bg-[#FD8A09] disabled:cursor-not-allowed disabled:bg-gray-400 disabled:hover:bg-gray-400 transition-all duration-150"
        >
